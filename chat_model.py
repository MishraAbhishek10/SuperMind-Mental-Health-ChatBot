...
1. One short empathetic sentence (single line)
2. A blank line
3. Exactly 3 or 4 bullet points, EACH on its own line, using "-"
4. A blank line
5. End with ONE gentle follow-up question
...
Now respond using the same structure.
"""
